...
type Gauge struct {
	...
	StartTime witTypes.Option[wasi_clocks_wall_clock.Datetime]
...
type HistogramDataPoint struct {
	...
	Min witTypes.Option[MetricNumber]
	// The maximum value recorded.
	Max witTypes.Option[MetricNumber]
...
func Export(metrics ResourceMetrics) witTypes.Result[witTypes.Unit, string] {
	...
	result249 := witRuntime.Allocate(pinner, uintptr(length250*(12*4)), 4)
	for index, element := range slice248 {
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(base), 0)) = uint32(uintptr(uintptr(utf84)))
		...
		result10 := witRuntime.Allocate(pinner, uintptr(length11*(4*4)), 4)
		...
		*(*uint32)(unsafe.Add(unsafe.Pointer(base), (8 * 4))) = uint32(uintptr(uintptr(result10)))
		...
		result246 := witRuntime.Allocate(pinner, uintptr(length247*(48+8*4)), 8)
			...
			*(*uint32)(unsafe.Add(unsafe.Pointer(base), (4 * 4))) = uint32(uintptr(uintptr(utf814)))
			...
			case MetricDataF64Gauge:
				...
				*(*int8)(unsafe.Add(unsafe.Pointer(base), (6 * 4))) = int8(int32(0))
				...
				result31 := witRuntime.Allocate(pinner, uintptr(length32*(16+4*4)), 8)
				for index, element := range slice30 {
					...
					result18 := witRuntime.Allocate(pinner, uintptr(length19*(4*4)), 4)
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(base), 0)) = uint32(uintptr(uintptr(result18)))
					...
					result28 := witRuntime.Allocate(pinner, uintptr(length29*(32+6*4)), 8)
					for index, element := range slice27 {
						...
						result23 := witRuntime.Allocate(pinner, uintptr(length24*(4*4)), 4)
			...
			case MetricDataF64Sum:
				...
				*(*int8)(unsafe.Add(unsafe.Pointer(base), (6 * 4))) = int8(int32(1))
				...
				result49 := witRuntime.Allocate(pinner, uintptr(length50*(16+4*4)), 8)
				for index, element := range slice48 {
					...
					result36 := witRuntime.Allocate(pinner, uintptr(length37*(4*4)), 4)
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(base), 0)) = uint32(uintptr(uintptr(result36)))
					...
					result46 := witRuntime.Allocate(pinner, uintptr(length47*(32+6*4)), 8)
					for index, element := range slice45 {
						...
						result41 := witRuntime.Allocate(pinner, uintptr(length42*(4*4)), 4)
			...
			case MetricDataF64Histogram:
				...
				*(*int8)(unsafe.Add(unsafe.Pointer(base), (6 * 4))) = int8(int32(2))
				...
				result69 := witRuntime.Allocate(pinner, uintptr(length70*(72+8*4)), 8)
				for index, element := range slice68 {
					...
					result55 := witRuntime.Allocate(pinner, uintptr(length56*(4*4)), 4)
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(base), (8 + 4*4))) = uint32(uintptr(uintptr(data57)))
					...
					result66 := witRuntime.Allocate(pinner, uintptr(length67*(32+6*4)), 8)
					for index, element := range slice65 {
						...
						result61 := witRuntime.Allocate(pinner, uintptr(length62*(4*4)), 4)
			...
			case MetricDataF64ExponentialHistogram:
				...
				*(*int8)(unsafe.Add(unsafe.Pointer(base), (6 * 4))) = int8(int32(3))
				...
				result89 := witRuntime.Allocate(pinner, uintptr(length90*(96+10*4)), 8)
				for index, element := range slice88 {
					...
					result74 := witRuntime.Allocate(pinner, uintptr(length75*(4*4)), 4)
					...
					*(*float64)(unsafe.Add(unsafe.Pointer(base), (88 + 8*4))) = (element).ZeroThreshold
					...
					result86 := witRuntime.Allocate(pinner, uintptr(length87*(32+6*4)), 8)
					for index, element := range slice85 {
						...
						result81 := witRuntime.Allocate(pinner, uintptr(length82*(4*4)), 4)
			...
			case MetricDataU64Gauge:
				...
				*(*int8)(unsafe.Add(unsafe.Pointer(base), (6 * 4))) = int8(int32(4))
				...
				result107 := witRuntime.Allocate(pinner, uintptr(length108*(16+4*4)), 8)
				for index, element := range slice106 {
					...
					result94 := witRuntime.Allocate(pinner, uintptr(length95*(4*4)), 4)
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(base), 0)) = uint32(uintptr(uintptr(result94)))
					...
					result104 := witRuntime.Allocate(pinner, uintptr(length105*(32+6*4)), 8)
					for index, element := range slice103 {
						...
						result99 := witRuntime.Allocate(pinner, uintptr(length100*(4*4)), 4)
			...
			case MetricDataU64Sum:
				...
				*(*int8)(unsafe.Add(unsafe.Pointer(base), (6 * 4))) = int8(int32(5))
				...
				result125 := witRuntime.Allocate(pinner, uintptr(length126*(16+4*4)), 8)
				for index, element := range slice124 {
					...
					result112 := witRuntime.Allocate(pinner, uintptr(length113*(4*4)), 4)
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(base), 0)) = uint32(uintptr(uintptr(result112)))
					...
					result122 := witRuntime.Allocate(pinner, uintptr(length123*(32+6*4)), 8)
					for index, element := range slice121 {
						...
						result117 := witRuntime.Allocate(pinner, uintptr(length118*(4*4)), 4)
			...
			case MetricDataU64Histogram:
				...
				*(*int8)(unsafe.Add(unsafe.Pointer(base), (6 * 4))) = int8(int32(6))
				...
				result146 := witRuntime.Allocate(pinner, uintptr(length147*(72+8*4)), 8)
				for index, element := range slice145 {
					...
					result131 := witRuntime.Allocate(pinner, uintptr(length132*(4*4)), 4)
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(base), (8 + 4*4))) = uint32(uintptr(uintptr(data134)))
					...
					result143 := witRuntime.Allocate(pinner, uintptr(length144*(32+6*4)), 8)
					for index, element := range slice142 {
						...
						result138 := witRuntime.Allocate(pinner, uintptr(length139*(4*4)), 4)
			...
			case MetricDataU64ExponentialHistogram:
				...
				*(*int8)(unsafe.Add(unsafe.Pointer(base), (6 * 4))) = int8(int32(7))
				...
				result166 := witRuntime.Allocate(pinner, uintptr(length167*(96+10*4)), 8)
				for index, element := range slice165 {
					...
					result151 := witRuntime.Allocate(pinner, uintptr(length152*(4*4)), 4)
					...
					*(*float64)(unsafe.Add(unsafe.Pointer(base), (88 + 8*4))) = (element).ZeroThreshold
					...
					result163 := witRuntime.Allocate(pinner, uintptr(length164*(32+6*4)), 8)
					for index, element := range slice162 {
						...
						result158 := witRuntime.Allocate(pinner, uintptr(length159*(4*4)), 4)
			...
			case MetricDataS64Gauge:
				...
				*(*int8)(unsafe.Add(unsafe.Pointer(base), (6 * 4))) = int8(int32(8))
				...
				result184 := witRuntime.Allocate(pinner, uintptr(length185*(16+4*4)), 8)
				for index, element := range slice183 {
					...
					result171 := witRuntime.Allocate(pinner, uintptr(length172*(4*4)), 4)
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(base), 0)) = uint32(uintptr(uintptr(result171)))
					...
					result181 := witRuntime.Allocate(pinner, uintptr(length182*(32+6*4)), 8)
					for index, element := range slice180 {
						...
						result176 := witRuntime.Allocate(pinner, uintptr(length177*(4*4)), 4)
			...
			case MetricDataS64Sum:
				...
				*(*int8)(unsafe.Add(unsafe.Pointer(base), (6 * 4))) = int8(int32(9))
				...
				result202 := witRuntime.Allocate(pinner, uintptr(length203*(16+4*4)), 8)
				for index, element := range slice201 {
					...
					result189 := witRuntime.Allocate(pinner, uintptr(length190*(4*4)), 4)
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(base), 0)) = uint32(uintptr(uintptr(result189)))
					...
					result199 := witRuntime.Allocate(pinner, uintptr(length200*(32+6*4)), 8)
					for index, element := range slice198 {
						...
						result194 := witRuntime.Allocate(pinner, uintptr(length195*(4*4)), 4)
			...
			case MetricDataS64Histogram:
				...
				*(*int8)(unsafe.Add(unsafe.Pointer(base), (6 * 4))) = int8(int32(10))
				...
				result223 := witRuntime.Allocate(pinner, uintptr(length224*(72+8*4)), 8)
				for index, element := range slice222 {
					...
					result208 := witRuntime.Allocate(pinner, uintptr(length209*(4*4)), 4)
					...
					*(*uint32)(unsafe.Add(unsafe.Pointer(base), (8 + 4*4))) = uint32(uintptr(uintptr(data211)))
					...
					result220 := witRuntime.Allocate(pinner, uintptr(length221*(32+6*4)), 8)
					for index, element := range slice219 {
						...
						result215 := witRuntime.Allocate(pinner, uintptr(length216*(4*4)), 4)
			...
			case MetricDataS64ExponentialHistogram:
				...
				*(*int8)(unsafe.Add(unsafe.Pointer(base), (6 * 4))) = int8(int32(11))
				...
				result243 := witRuntime.Allocate(pinner, uintptr(length244*(96+10*4)), 8)
				for index, element := range slice242 {
					...
					result228 := witRuntime.Allocate(pinner, uintptr(length229*(4*4)), 4)
					...
					*(*float64)(unsafe.Add(unsafe.Pointer(base), (88 + 8*4))) = (element).ZeroThreshold
					...
					result240 := witRuntime.Allocate(pinner, uintptr(length241*(32+6*4)), 8)
					for index, element := range slice239 {
						...
						result235 := witRuntime.Allocate(pinner, uintptr(length236*(4*4)), 4)
	...
	var result251 witTypes.Result[witTypes.Unit, string]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result251 = witTypes.Ok[witTypes.Unit, string](witTypes.Unit{})
	case 1:
		...
		result251 = witTypes.Err[witTypes.Unit, string](value)
	default:
		panic("unreachable")
	}
	result252 := result251
